...
nohup hits -p D -g ~/db/Sclerotinia_sclerotiorum/current/bowtie2/Sclerotinia_sclerotiorum.genome.fa -d $1 -o $dir_name/$base_name.outdir -t 8 1>$dir_name/$base_name.dnaseq_log.txt 2>&1 &
