...
nohup hits -p D -g ~/db/Saccharomyces_cerevisiae/current/bowtie2/Saccharomyces_cerevisiae.R64-1-1.genome.fa -d $1 -o $dir_name/$base_name.outdir -t 8 1>$dir_name/$base_name.dnaseq_log.txt 2>&1 &
