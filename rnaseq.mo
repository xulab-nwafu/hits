...
nohup hits -p R -g ~/db/Magnaporthe_oryzae/current/hisat2/Magnaporthe_oryzae.genome.fa -a ~/db/Magnaporthe_oryzae/current/Magnaporthe_oryzae.gtf -s 1 -d $1 -o $dir_name/$base_name.outdir -t 8 1>$dir_name/$base_name.rnaseq_log.txt 2>&1 &
